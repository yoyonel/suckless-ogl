/**
 * @file postprocess_presets.c
 * @brief Definitions of predefined post-processing pipeline configurations.
 *
 * All preset instances live in a single translation unit (single .rodata copy)
 * and are exposed via extern declarations in postprocess_presets.h.
 */
