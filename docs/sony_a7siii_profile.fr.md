...
Référence technique pour le profil de capteur Sony Alpha 7S III implémenté dans `suckless-ogl`.
...
- **Appliquer le Profil Sony A7S III** : Appuyez sur `F8`.
- **Basculer le Lattice Debugger 3D LUT** : Appuyez sur `Shift + F10` lorsqu'un profil avec LUT est actif.
