...
LogLevel log_get_level(void) { return LOG_LEVEL_INFO; }
...
void glShaderSource(GLuint shader, GLsizei count, const GLchar** string, const GLint* length) { (void)shader; (void)count; (void)string; (void)length; }
void glCompileShader(GLuint shader) { (void)shader; }
void glGetShaderiv(GLuint shader, GLenum pname, GLint* params) { (void)shader; (void)pname; *params = GL_TRUE; }
...
void glGetProgramiv(GLuint program, GLenum pname, GLint* params) { (void)program; (void)pname; *params = GL_TRUE; }
...
void glObjectLabel(GLenum identifier, GLuint name, GLsizei length, const GLchar* label) { (void)identifier; (void)name; (void)length; (void)label; }
...
void glUniform1f(GLint location, float v0) { (void)location; (void)v0; }
void glUniform2fv(GLint location, GLsizei count, const float* value) { (void)location; (void)count; (void)value; }
void glUniform3fv(GLint location, GLsizei count, const float* value) { (void)location; (void)count; (void)value; }
void glUniform4fv(GLint location, GLsizei count, const float* value) { (void)location; (void)count; (void)value; }
void glUniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose, const float* value) { (void)location; (void)count; (void)transpose; (void)value; }
...
void test_get_dir_from_path_success(void) {
    ...
    ASSERT_TRUE(strcmp(out_buf, "/tmp/") == 0, "get_dir_from_path output correct");
}
...
void test_parse_include_path_truncation(void) {
    ...
    const char* result = parse_include_path(input, out_buf, sizeof(out_buf));
    ASSERT_TRUE(result == NULL, "parse_include_path should fail on truncation");
}
...
void test_parse_include_path_success(void) {
    ...
    ASSERT_TRUE(strcmp(out_buf, "header.glsl") == 0, "parse_include_path output correct");
}
