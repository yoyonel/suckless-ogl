...
static void assert_capture_contains(const char* expected_level, const char* expected_tag, const char* expected_msg) {
    ...
    // Check components
    TEST_ASSERT_NOT_NULL_MESSAGE(strstr(buffer, expected_level), "Level not found in log");
    TEST_ASSERT_NOT_NULL_MESSAGE(strstr(buffer, expected_tag), "Tag not found in log");
    TEST_ASSERT_NOT_NULL_MESSAGE(strstr(buffer, expected_msg), "Message not found in log");
}
