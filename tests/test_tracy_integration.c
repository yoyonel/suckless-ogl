...
void test_tracy_init(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(640, 480, "Tracy Test", NULL, NULL);
    if (!window) {
        glfwTerminate();
    ...
    // Simulate a zone
    TracySourceLocationData loc = { "TestZone", "test_tracy_init", "tests/test_tracy_integration.c", __LINE__, 0xFF0000 };
